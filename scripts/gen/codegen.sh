...
_do_gen_clients() {
  ...
  if [ -d "${GOPATH}/src/arhat.dev/ksync/pkg/apis/${group_name}/generated/clientset" ]; then
    mv "${GOPATH}/src/arhat.dev/ksync/pkg/apis/${group_name}/generated/clientset" "./pkg/apis/${group_name}/generated"
  fi

  if [ -d "${GOPATH}/src/arhat.dev/ksync/pkg/apis/${group_name}/generated/informers" ]; then
    mv "${GOPATH}/src/arhat.dev/ksync/pkg/apis/${group_name}/generated/informers" "./pkg/apis/${group_name}/generated"
  fi

  if [ -d "${GOPATH}/src/arhat.dev/ksync/pkg/apis/${group_name}/generated/listers" ]; then
    mv "${GOPATH}/src/arhat.dev/ksync/pkg/apis/${group_name}/generated/listers" "./pkg/apis/${group_name}/generated"
  fi
}
