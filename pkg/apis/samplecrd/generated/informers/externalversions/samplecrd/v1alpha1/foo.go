...
import (
	...
	versioned "arhat.dev/template-kubernetes-controller/pkg/apis/samplecrd/generated/clientset/versioned"
	internalinterfaces "arhat.dev/template-kubernetes-controller/pkg/apis/samplecrd/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "arhat.dev/template-kubernetes-controller/pkg/apis/samplecrd/generated/listers/samplecrd/v1alpha1"
	samplecrdv1alpha1 "arhat.dev/template-kubernetes-controller/pkg/apis/samplecrd/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecrdV1alpha1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecrdV1alpha1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&samplecrdv1alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplecrdv1alpha1.Foo{}, f.defaultInformer)
}
