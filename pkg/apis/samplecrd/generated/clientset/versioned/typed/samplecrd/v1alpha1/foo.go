...
import (
	...
	scheme "arhat.dev/template-kubernetes-controller/pkg/apis/samplecrd/generated/clientset/versioned/scheme"
...
func newFoos(c *SamplecrdV1alpha1Client, namespace string) *foos {
	return &foos{
		client: c.RESTClient(),
		ns:     namespace,
	}
